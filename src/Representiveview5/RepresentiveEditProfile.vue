  ...
  <div class=" grid grid-cols gap-4">
    ...
    <div class="  grid-cols-9  p-4 bg-white border border-gray-200 rounded-lg shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div class="flex flex-col items-center pb-10">
        <img class="w-24 h-24 mb-3 rounded-full shadow-lg mt-3" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1Tyom2tGGTFNI69YWk3_v4UDPiCclNcxZaKdVKC-N&s" alt="Bonnie image"/>
        <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Ali Alzebir </h5>
        <span class="text-sm text-gray-500 dark:text-gray-400">Shipping Representive</span>
