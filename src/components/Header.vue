  ...
  <div class="flex items-center">
    ...
    <div class="relative">
      ...
      >
        <img
          class="object-cover w-full h-full"
          src="https://thumbs.dreamstime.com/b/settings-icon-vector-isolated-white-background-settings-sign-settings-icon-vector-isolated-white-background-settings-134151900.jpg"
          alt="Your avatar"
        />
      </button>
...
<header
v-else-if="userRole=='representive'"  
